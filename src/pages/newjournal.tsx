            ...
            >
              ...
              <td className="">
                ...
                {/* {JSON.stringify(metrics)} */}
                {
                  ...
                  data-tooltip-content={JSON.stringify(metrics)}
                >
...
<Tooltip id="metric-tooltip" />
              ...
              <td className="pl-5">
                {/* should take you to the individual habit view for this id */}
                <button className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-sm leading-none text-gray-600 py-2 px-2 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">
                  View
                </button>
              </td>
              <td>
                <div className="relative px-2 pt-1">
                  <button
                    className="focus:ring-1 rounded-lg focus:outline-none"
                    role="button"
                    aria-label="option"
                  >
                    <RxGear className="text-gray-500"></RxGear>
                  </button>
                </div>
              </td>
    ...
    <div className="bg-white py-3 md:py-4 px-4 md:px-6 xl:px-10">
      ...
      <div className="mt-7 overflow-x-auto">
        <table className="w-full whitespace-nowrap">
          <thead>
            <tr className="text-xs justify-between text-center font-semibold">
              <td></td>
              <td>Type</td>
              <td>Score</td>
              <td>Name</td>
