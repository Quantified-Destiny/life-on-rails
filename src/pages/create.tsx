...
<div className="mx-auto max-w-xl border border-gray-200 px-4 py-6 sm:px-6 lg:px-8">
  ...
  <div className="flex flex-col space-y-4">
    <button type="button" className="inline-flex items-center rounded-md border border-transparent bg-green-600 px-4 py-2 font-semibold text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
      <span className="mr-2"><i className="fas fa-bullseye"></i></span>
